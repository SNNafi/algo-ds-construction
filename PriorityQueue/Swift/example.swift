...
var array = [12, 7, 1, 3, 10, 17, 19, 2, 5]

MaxHeapify.buildMaxHeap(heap: &array, heapSize: array.count - 1)
MaxHeapify.printHeap(heap: array, heapSize: array.count - 1, root: 0)
print("")
print(PriorityQueue.extractMax(heap: &array))
print("")
MaxHeapify.printHeap(heap: array, heapSize: array.count - 1, root: 0)

PriorityQueue.insert(value: 89, heap: &array)
print("")
MaxHeapify.printHeap(heap: array, heapSize: array.count - 1, root: 0)